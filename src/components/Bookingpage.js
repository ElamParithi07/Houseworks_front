...
export default function Bookingpage(){
    ...
    async function passdetails(c_uname,p_uname,cmp,ser,pr){
        ...
        await axios.post('https://houseworks-back.onrender.com/booking',values)
    ...
    const fetchbookingData = async () => {
        try {
        const response = await axios.get("https://houseworks-back.onrender.com/companybook/"+location.state.prof_uname,{
