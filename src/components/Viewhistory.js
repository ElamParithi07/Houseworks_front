...
export default function Viewhistory(){
    ...
    const response = await axios.get("https://houseworks-back.onrender.com/booking/professional/"+parsedData.data.uname);
    ...
    async function fetch1 (){
        const response = await axios.get("https://houseworks-back.onrender.com/booking/customer/"+parsedData.data.uname);
