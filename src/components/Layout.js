...
export default function Layout() {
  ...
  return (
    <div>
      <nav className="navbar navbar-expand-md navbar-light bg-transparent navbar-fixed">
        <div className="container">
          <p className="navbar-brand fs-1 text-black">
            <img src="HouseWorks.png" alt="houseworks" style={{ height: "80px" }}></img>
          </p>
            ...
            <div className="offcanvas-body d-flex flex-column flex-lg-row p-4 p-lg-0">
              <ul className="navbar-nav justify-content-center align-items-center flex-grow-1 pe-3">
                <li className="nav-item">
                  <button className="nav-link mx-2 active text-black " aria-current="page"><Link style={{ textDecoration: "none", color: "black" }} to="/">Home</Link></button>
                </li>
                <li className="nav-item">
                  <button className="nav-link mx-2 text-black" ><Link style={{ textDecoration: "none", color: "black" }} to="/Search">Book a Service</Link></button>
                </li>
                <li className="nav-item">
      ...
      {/* <footer className="container">
          <hr></hr>
          <div className="d-flex" style={{padding:"80px",justifyContent:"space-between"}}>
              <div>
                <img src="HouseWorks.png" alt="Logo" style={{height:"80px"}}></img>
                <p>Follow Us</p>
              </div>
              <div>
                  <h3>Company</h3>
